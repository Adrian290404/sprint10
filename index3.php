...
<ol>
    <?php foreach ($rooms as $room) :?>
        <li>
            ...
            <img src="<?php echo $room['image'];?>" alt="<?php echo $room['room_name'];?>">
            <p>Bed Type: <?php echo $room['bed_type'];?></p>
            <p>Room Floor: <?php echo $room['room_floor'];?></p>
            <p>Facilities: <?php echo $room['facilities'];?></p>
            <p>Price: $<?php echo $room['rate'];?> per night</p>
            <p>Available: <?php echo $room['avaiable']? 'Yes' : 'No';?></p>
            <br><br><br><br>
        </li>
    <?php endforeach;?>
</ol>